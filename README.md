...
| [blog-affiliate-pipeline-design.md](docs/plans/blog-affiliate-pipeline-design.md) | 実装リポ `blog-affiliate-pipeline` の構成設計 |
...
**PR 自動レビュー**: [cursor-pr-review.yml](.github/workflows/cursor-pr-review.yml)（要 `CURSOR_API_KEY`）。詳細は [branch-protection.md](docs/branch-protection.md)。
